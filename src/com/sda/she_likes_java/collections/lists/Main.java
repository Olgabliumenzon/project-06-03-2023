...
//        b = 8;
        //expandable list
        List<Trousers> trousers = new ArrayList<>(); // use this longer way for list to be able to add items later on
        ...
        //frozen list :)
        List<Trousers> trousersList = List.of( //use "list.of" if you are not going to add anything to the list later on
